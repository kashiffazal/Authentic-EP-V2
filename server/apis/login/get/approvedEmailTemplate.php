<?php 
  ...
  <div style="margin:0 auto;max-width:560px;min-width:280px;width:280px;width:calc(28000% - 167440px);font-family:sans-serif">
    <p style="margin:0px;padding:10px 0px;font-size:12px;color:#717a8a;">Account approved by administrator</p>
  </div><!--End Container -->
  ...
  <div role="section" style="background-color:#ffffff">
    <div style="margin:0 auto;max-width:600px;min-width:320px;width:320px;width:calc(28000% - 167400px);word-wrap:break-word;word-break:break-word;font-family:sans-serif">
      <div style="margin:0px 20px;">
        ...
        <br/>
        <h1 style="margin:0px;font-weight:normal;color:#111324;font-size:22px;line-height:31px;">Your account has been approved!</h1>
        <br/>
        <p style="margin:0px">You can login your account by clicking Login button below.</p>
        <br/>
        <a 
          ...
          href="'.$redirectPath.'" target="_blank" >Login</a>
        <br/><br/>
      </div><!--End margins-->
    </div><!--End Container -->
    <br/><br/>
