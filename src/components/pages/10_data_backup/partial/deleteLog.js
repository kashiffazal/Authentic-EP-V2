...
import { HTTP, TableColumnFilter, InsertRowInList, SortableDateInTableData } from '../../../services';
...
class DeleteLog extends Component {
    ...
    const columns = [
      {
        ...
        dataIndex: 'updated_date_formatted',
        width: '16%',
        align: 'center',
        sorter: (a, b) => a.updated_date.localeCompare(b.updated_date),
        ...TableColumnFilter('updated_date_formatted')
      }, {
        title: 'Delete By',
        dataIndex: 'updated_by_name',
        width: '13%',
        sorter: (a, b) => a.updated_by_name.localeCompare(b.updated_by_name),
        ...TableColumnFilter('updated_by_name')
      }, {
        title: 'Past Status',
        dataIndex: 'oldStatus',
        width: '10%',
        ...
        <ScreenLoader active={st.loader}>
          <DataTable
            ...
            customFilterCol={[
              ...
              { label: 'Delete Date & Time', value: 'updated_date_formatted' },
              { label: 'Delete By', value: 'updated_by_name' },
              { label: 'Past Status', value: 'oldStatus' },
  ...
  componentDidMount() { this.getData('deleted'); }//End componentDidMount
