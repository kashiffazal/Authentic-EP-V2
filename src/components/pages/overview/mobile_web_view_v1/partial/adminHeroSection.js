          ...
          <div className="info-section">
            {loader ? <span className="custom-loader"><LoadingOutlined /> &nbsp; Loading, Please wait...</span> :
              <table width="100%" className="text-center">
                <tbody>
                  <tr>
                    <td width="33.3%"><span>Total SP <br /><b>{dtc.spCount}</b></span></td>
                    <td width="33.3%"><span>Total Client <br /><b>{dtc.clCount}</b></span></td>
                    <td width="33.3%"><span>Total Services <br /><b>{dtc.srCount}</b></span></td>
                  </tr>
                </tbody>
              </table>
            }
